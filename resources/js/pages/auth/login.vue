                ...
                <!-- <div class="card">
                  <div class="card-body">
                    ...
                    <div class="table-responsive">
                      <table
                        class="table table-bordered red-border text-center"
                      >
                        <thead>
                          <tr>
                            <th>Role</th>
                        ...
                        <tbody>
                          <tr>
                            ...
                            <td scope="row">
                              <button
                                v-tooltip="$t('Login as super admin')"
                                class="btn"
                                @click="
                                  loginCredential(
                          ...
                          <tr>
                            ...
                            <td scope="row">
                              <button
                                v-tooltip="$t('Login as super manager')"
                                class="btn"
                                @click="
                                  loginCredential(
                          ...
                          <tr>
                            ...
                            <td scope="row">
                              <button
                                v-tooltip="$t('Login as super salesman')"
                                class="btn"
                                @click="
                                  loginCredential(
                                    'sales@acculance.com',
